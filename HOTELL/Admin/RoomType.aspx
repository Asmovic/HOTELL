<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RoomType.aspx.cs" Inherits="HOTELL.Admin.RoomType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <h4>Room Type Setup</h4>
  
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label"><strong>Type Code</strong></asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label"><strong>Type Description</strong></asp:Label>
            <div class="col-md-8">
