<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CostCenter.aspx.cs" Inherits="HOTELL.Admin.CostCenter" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <h4>Cost Center Setup</h4>
  
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label"><strong>Cost Center Code</strong></asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label"><strong>Cost Center Name</strong></asp:Label>
            <div class="col-md-8">
