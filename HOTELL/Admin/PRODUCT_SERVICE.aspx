<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PRODUCT_SERVICE.aspx.cs" Inherits="HOTELL.Admin.PRODUCT_SERVICE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <h4>Product/Service Setup</h4>

            <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Product/Service Code</asp:Label>
            <div class="col-md-8">
            ...
            <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Product/Service Desc</asp:Label>
            <div class="col-md-8">
              ...
              <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Rate</asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Sub Cat Name</asp:Label>
            <div class="col-md-8">
                <asp:DropDownList runat ="server" CssClass="form-control" ID="cmbscat" AutoPostBack ="true" OnSelectedIndexChanged="cmbscat_SelectedIndexChanged"></asp:DropDownList>
                
                <asp:RequiredFieldValidator runat="server" ControlToValidate="cmbscat" CssClass="text-danger" ErrorMessage="This field is required." />
            </div>
             </div>
