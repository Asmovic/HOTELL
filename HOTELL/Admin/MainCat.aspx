<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MainCat.aspx.cs" Inherits="HOTELL.Admin.MainCat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <h4>Main Category Setup</h4>
  
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label"><strong>Main Category Code</strong></asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label"><strong>Main Category Name</strong></asp:Label>
            <div class="col-md-8">
